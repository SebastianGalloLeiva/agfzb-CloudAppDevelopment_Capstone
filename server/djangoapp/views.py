...
def get_dealer_details(request, id):
    if request.method == "GET":
        context = {}
        dealer_url = "https://us-south.functions.appdomain.cloud/api/v1/web/3dc499df-22c6-4250-872c-435c1fbc7775/dealership-package/get-dealership"
...
def add_review(request, id):
    ...
    if request.method == 'GET':
        ...
        if request.user.is_authenticated:
            ...
            review_post_url = "https://us-south.functions.appdomain.cloud/api/v1/web/3dc499df-22c6-4250-872c-435c1fbc7775/dealership-package/post-review"
